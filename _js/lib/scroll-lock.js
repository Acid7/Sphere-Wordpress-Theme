...
var scroll_lock_fillGapTarget = function fillGapTarget($target) {
  ...
  if (isElement($target)) {
	...
	document.documentElement.style.setProperty('--scrollbar-gap', scrollBarWidth + "px"); // A7 ~ Change Scrollbar Gap CSS Variable
...
var scroll_lock_unfillGapTarget = function unfillGapTarget($target) {
  if (isElement($target)) {
	...
	document.documentElement.style.setProperty('--scrollbar-gap', "0px"); // A7 ~ Reset Scrollbar Gap CSS Variable
